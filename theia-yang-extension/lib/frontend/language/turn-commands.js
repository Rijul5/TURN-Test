...
var TURNCommandContribution = /** @class */ (function () {
    function TURNCommandContribution(workspace) {
        this.workspace = workspace;
    }
    TURNCommandContribution.prototype.registerCommands = function (commands) {
        var _this = this;
        commands.registerCommand(exports.SHOW_TURN_REFERENCES, {
    ...
    TURNCommandContribution = __decorate([
        inversify_1.injectable(),
        __param(0, inversify_1.inject(common_1.Workspace)),
        __metadata("design:paramtypes", [Object])
    ], TURNCommandContribution);
    return TURNCommandContribution;
}());
exports.TURNCommandContribution = TURNCommandContribution;
//# sourceMappingURL=turn-commands.js.map