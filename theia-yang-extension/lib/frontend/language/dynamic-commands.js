...
var ContextMenuCommands = /** @class */ (function () {
    ...
    ContextMenuCommands.prototype.registerCommand = function (id, callback, thisArg) {
        ...
        var removeCommand = this.registry.registerCommand({ id: id }, {
            execute: function () {
                ...
                if (_this.isTURNEditor(currentEditor)) {
                    execute(currentEditor.editor.document.uri);
                }
            },
            isVisible: function () { return _this.isTURNEditor(_this.editorManager.currentEditor); }
        });
        var removeMenu = this.menuRegistry.registerMenuAction(browser_1.EDITOR_CONTEXT_MENU.concat("2_turn"), {
            commandId: id,
            label: id
        });
        return {
    ...
    ContextMenuCommands.prototype.isTURNEditor = function (widget) {
        if (widget)
    ...
    ContextMenuCommands = __decorate([
        ...
        __param(0, inversify_1.inject(core_1.MenuModelRegistry)),
        __param(1, inversify_1.inject(core_1.CommandRegistry)),
        __param(2, inversify_1.inject(browser_1.EditorManager)),
        __metadata("design:paramtypes", [core_1.MenuModelRegistry,
