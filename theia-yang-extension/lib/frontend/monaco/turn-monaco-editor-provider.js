...
var TURNMonacoEditorProvider = /** @class */ (function (_super) {
    __extends(TURNMonacoEditorProvider, _super);
    function TURNMonacoEditorProvider(editorService, monacoModelResolver, contextMenuService, m2p, p2m, workspace, commandServiceFactory, editorPreferences, quickOpenService, diffNavigatorFactory) {
    ...
    TURNMonacoEditorProvider.prototype.createMonacoEditorOptions = function (model) {
    ...
    TURNMonacoEditorProvider = __decorate([
        ...
        __param(3, inversify_1.inject(lib_1.MonacoToProtocolConverter)),
        __param(4, inversify_1.inject(lib_1.ProtocolToMonacoConverter)),
        ...
        __metadata("design:paramtypes", [monaco_editor_service_1.MonacoEditorService,
            ...
            lib_1.MonacoToProtocolConverter,
    ...
    ], TURNMonacoEditorProvider);
    return TURNMonacoEditorProvider;
}(monaco_editor_provider_1.MonacoEditorProvider));
exports.TURNMonacoEditorProvider = TURNMonacoEditorProvider;
//# sourceMappingURL=turn-monaco-editor-provider.js.map