...
import { MonacoToProtocolConverter, ProtocolToMonacoConverter } from 'monaco-languageclient/lib';
...
export declare class TURNMonacoEditorProvider extends MonacoEditorProvider {
...
//# sourceMappingURL=turn-monaco-editor-provider.d.ts.map