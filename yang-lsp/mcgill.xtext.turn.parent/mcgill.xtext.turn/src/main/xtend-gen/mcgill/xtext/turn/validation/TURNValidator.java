...
public class TURNValidator extends AbstractTURNValidator {
    ...
    for (final UCMmap map : _allContentsOfType) {
      {
        ...
        String _plus = ("testing map name: " + _name);
        String _plus_1 = (_plus + " and long is: ");
        LongName _longName = map.getLongName();
        String _plus_2 = (_plus_1 + _longName);
        String _plus_3 = (_plus_2 + " obj longname is: ");
        LongName _longName_1 = obj.getLongName();
        String _plus_4 = (_plus_3 + _longName_1);
        InputOutput.<String>println(_plus_4);
        boolean _notEquals = (!Objects.equal(map, obj));
        InputOutput.<Boolean>println(Boolean.valueOf(_notEquals));
        if (((obj.getLongName().getLongname() != null) && obj.getLongName().getLongname().isEmpty())) {
          this.error("Map longname must not be empty", TURNPackage.Literals.UC_MMAP__LONG_NAME);
        }
        ...
        if (((((obj.getLongName().getLongname() != null) && (map.getLongName().getLongname() != null)) && map.getLongName().getLongname().equals(obj.getLongName().getLongname())) && (!Objects.equal(map, obj)))) {
  ...
  public void checkConcernHasUniqueName(final Concern obj) {
    ...
    for (final Concern concern : _allContentsOfType) {
      {
        if (((obj.getLongName().getLongname() != null) && obj.getLongName().getLongname().isEmpty())) {
          this.error("Concern longname must not be empty", TURNPackage.Literals.CONCERN__LONG_NAME);
        }
        ...
        if ((((((obj.getLongName().getLongname() != null) && (concern.getLongName().getLongname() != null)) && (!concern.getLongName().getLongname().isEmpty())) && concern.getLongName().getLongname().equals(obj.getLongName().getLongname())) && (!Objects.equal(concern, obj)))) {
  ...
  public void checkActorHasUniqueName(final Actor obj) {
    ...
    for (final Actor actor : _allContentsOfType) {
      {
        if (((obj.getLongName().getLongname() != null) && obj.getLongName().getLongname().isEmpty())) {
          this.error("Actor longname must not be empty", TURNPackage.Literals.ACTOR__LONG_NAME);
        }
        ...
        if ((((((obj.getLongName().getLongname() != null) && (actor.getLongName().getLongname() != null)) && (!actor.getLongName().getLongname().isEmpty())) && actor.getLongName().getLongname().equals(obj.getLongName().getLongname())) && (!Objects.equal(actor, obj)))) {
  ...
  public void checkIntElementHasUniqueName(final IntentionalElement obj) {
    ...
    for (final IntentionalElement intElem : _allContentsOfType) {
      {
        if (((obj.getLongName().getLongname() != null) && obj.getLongName().getLongname().isEmpty())) {
          this.error("IntentionalElement longname must not be empty", TURNPackage.Literals.INTENTIONAL_ELEMENT__LONG_NAME);
        }
        ...
        if ((((((obj.getLongName().getLongname() != null) && (intElem.getLongName().getLongname() != null)) && (!intElem.getLongName().getLongname().isEmpty())) && intElem.getLongName().getLongname().equals(obj.getLongName().getLongname())) && (!Objects.equal(intElem, obj)))) {
  ...
  public void checkContributionHasUniqueName(final Contribution obj) {
    ...
    for (final Contribution cont : _allContentsOfType) {
      {
        if (((obj.getLongName().getLongname() != null) && obj.getLongName().getLongname().isEmpty())) {
          this.error("Contribution longname must not be empty", TURNPackage.Literals.CONTRIBUTION__LONG_NAME);
        }
        ...
        if ((((((obj.getLongName().getLongname() != null) && (cont.getLongName().getLongname() != null)) && (!cont.getLongName().getLongname().isEmpty())) && cont.getLongName().getLongname().equals(obj.getLongName().getLongname())) && (!Objects.equal(cont, obj)))) {
  ...
  public void checkDecompositionHasUniqueName(final Decomposition obj) {
    ...
    for (final Decomposition decomp : _allContentsOfType) {
      {
        if (((obj.getLongName().getLongname() != null) && obj.getLongName().getLongname().isEmpty())) {
          this.error("Decomposition longname must not be empty", TURNPackage.Literals.DECOMPOSITION__LONG_NAME);
        }
        ...
        if ((((((obj.getLongName().getLongname() != null) && (decomp.getLongName().getLongname() != null)) && (!decomp.getLongName().getLongname().isEmpty())) && decomp.getLongName().getLongname().equals(obj.getLongName().getLongname())) && (!Objects.equal(decomp, obj)))) {
  ...
  public void checkDependencyHasUniqueName(final Dependency obj) {
    ...
    for (final Dependency dep : _allContentsOfType) {
      {
        if (((obj.getLongName().getLongname() != null) && obj.getLongName().getLongname().isEmpty())) {
          this.error("Dependency longname must not be empty", TURNPackage.Literals.DEPENDENCY__LONG_NAME);
        }
        ...
        if ((((((obj.getLongName().getLongname() != null) && (dep.getLongName().getLongname() != null)) && (!dep.getLongName().getLongname().isEmpty())) && dep.getLongName().getLongname().equals(obj.getLongName().getLongname())) && (!Objects.equal(dep, obj)))) {
  ...
  public void checkStrategiesGroupHasUniqueName(final StrategiesGroup obj) {
    ...
    for (final StrategiesGroup sg : _allContentsOfType) {
      {
        if (((obj.getLongName().getLongname() != null) && obj.getLongName().getLongname().isEmpty())) {
          this.error("StrategiesGroup longname must not be empty", TURNPackage.Literals.STRATEGIES_GROUP__LONG_NAME);
        }
        ...
        if ((((((obj.getLongName().getLongname() != null) && (sg.getLongName().getLongname() != null)) && (!sg.getLongName().getLongname().isEmpty())) && sg.getLongName().getLongname().equals(obj.getLongName().getLongname())) && (!Objects.equal(sg, obj)))) {
  ...
  public void checkStrategyHasUniqueName(final EvaluationStrategy obj) {
    ...
    for (final EvaluationStrategy sg : _allContentsOfType) {
      {
        if (((obj.getLongName().getLongname() != null) && obj.getLongName().getLongname().isEmpty())) {
          this.error("EvaluationStrategy longname must not be empty", TURNPackage.Literals.EVALUATION_STRATEGY__LONG_NAME);
        }
        if ((((!sg.getName().isEmpty()) && Objects.equal(sg.getName(), obj.getName())) && (!Objects.equal(sg, obj)))) {
  ...
  public void checkContribContextGroupHasUniqueName(final ContributionContextGroup obj) {
    ...
    for (final ContributionContextGroup sg : _allContentsOfType) {
      {
        if (((obj.getLongName().getLongname() != null) && obj.getLongName().getLongname().isEmpty())) {
          this.error("ContributionContextGroup longname must not be empty", TURNPackage.Literals.CONTRIBUTION_CONTEXT_GROUP__LONG_NAME);
        }
        if ((((!sg.getName().isEmpty()) && Objects.equal(sg.getName(), obj.getName())) && (!Objects.equal(sg, obj)))) {
  ...
  public void checkContribContextHasUniqueName(final ContributionContext obj) {
    ...
    for (final ContributionContext cc : _allContentsOfType) {
      {
        if (((obj.getLongName().getLongname() != null) && obj.getLongName().getLongname().isEmpty())) {
          this.error("ContributionContextGroup longname must not be empty", TURNPackage.Literals.CONTRIBUTION_CONTEXT__LONG_NAME);
        }
        ...
        if ((((((obj.getLongName().getLongname() != null) && (cc.getLongName().getLongname() != null)) && (!cc.getLongName().getLongname().isEmpty())) && cc.getLongName().getLongname().equals(obj.getLongName().getLongname())) && (!Objects.equal(cc, obj)))) {
  ...
  public void checkLinearConversionHasUniqueName(final LinearConversion obj) {
    ...
    for (final LinearConversion lc : _allContentsOfType) {
      {
        if (((obj.getLongName().getLongname() != null) && obj.getLongName().getLongname().isEmpty())) {
          this.error("LinearConversion longname must not be empty", TURNPackage.Literals.LINEAR_CONVERSION__LONG_NAME);
        }
        ...
        if ((((((obj.getLongName().getLongname() != null) && (lc.getLongName().getLongname() != null)) && (!lc.getLongName().getLongname().isEmpty())) && lc.getLongName().getLongname().equals(obj.getLongName().getLongname())) && (!Objects.equal(lc, obj)))) {
  ...
  public void checkQualToQMappingsHasUniqueName(final QualToQMappings obj) {
    ...
    for (final QualToQMappings mc : _allContentsOfType) {
      {
        if (((obj.getLongName().getLongname() != null) && obj.getLongName().getLongname().isEmpty())) {
          this.error("QualToQMappings longname must not be empty", TURNPackage.Literals.QUAL_TO_QMAPPINGS__LONG_NAME);
        }
        ...
        if ((((((obj.getLongName().getLongname() != null) && (mc.getLongName().getLongname() != null)) && mc.getLongName().getLongname().isEmpty()) && mc.getLongName().getLongname().equals(obj.getLongName().getLongname())) && (!Objects.equal(mc, obj)))) {
