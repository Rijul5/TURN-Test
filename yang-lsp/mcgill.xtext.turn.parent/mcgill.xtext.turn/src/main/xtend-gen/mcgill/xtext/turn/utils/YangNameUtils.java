...
public abstract class YangNameUtils {
  ...
  public static final class EClassWrapper {
    private final static YangNameUtils.EClassWrapper MISSING = new YangNameUtils.EClassWrapper(null);
  ...
  private final static LoadingCache<String, YangNameUtils.EClassWrapper> NAME_TO_ECLASS_CACHE = CacheBuilder.newBuilder().<String, YangNameUtils.EClassWrapper>build(
