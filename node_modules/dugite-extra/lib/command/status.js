 ...
 */
function getStatus(repositoryPath, limit) {
    if (limit === void 0) { limit = Number.MAX_SAFE_INTEGER; }
    return __awaiter(this, void 0, void 0, function () {
        var result, files, existingFiles, currentBranch, currentUpstreamBranch, currentTip, branchAheadBehind, _a, entries, incomplete, _loop_1, entries_1, entries_1_1, entry, workingDirectory, e_1, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    _a = status_parser_1.parsePorcelainStatus(result.stdout, limit), entries = _a.entries, incomplete = _a.incomplete;
