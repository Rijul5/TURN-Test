...
export declare function createGrammar(grammar: IRawGrammar, initialLanguage: number, embeddedLanguages: IEmbeddedLanguagesMap, tokenTypes: ITokenTypeMap, grammarRepository: IGrammarRepository & IThemeProvider): Grammar;
...
export declare class Grammar implements IGrammar, IRuleFactoryHelper {
    private _rootId;
    private _lastRuleId;
