...
export declare function createOnigString(sources: string): OnigString;
export declare function getString(str: OnigString): string;
export declare class RegExpSourceList {
    ...
    compile(grammar: IRuleRegistry, allowA: boolean, allowG: boolean): ICompiledRule;
    private _resolveAnchors(allowA, allowG);
}
...
export declare class BeginWhileRule extends Rule {
    ...
    compile(grammar: IRuleRegistry, endRegexSource: string, allowA: boolean, allowG: boolean): ICompiledRule;
    private _precompile(grammar);
    compileWhile(grammar: IRuleRegistry, endRegexSource: string, allowA: boolean, allowG: boolean): ICompiledRule;
